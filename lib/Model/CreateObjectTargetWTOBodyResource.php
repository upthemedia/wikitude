...
/**
 * CreateObjectTargetWTOBodyResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateObjectTargetWTOBodyResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateObjectTargetWTOBody_resource';
     ...
     * Sets uri
     *
     * @param string|null $uri Required - URL to the WTO resource.
     *
     * @return self
     */
