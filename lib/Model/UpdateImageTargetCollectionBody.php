...
/**
 * UpdateImageTargetCollectionBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateImageTargetCollectionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateImageTargetCollectionBody';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'cloud_archive' => '\OpenAPI\Client\Model\CreateImageTargetCollectionBodyCloudArchive',
        'metadata' => 'object'
    ];
     ...
     * Sets name
     *
     * @param string|null $name Optional - Name of the Target Collection.
     *
     * @return self
     */
     ...
     * Gets cloud_archive
     *
     * @return \OpenAPI\Client\Model\CreateImageTargetCollectionBodyCloudArchive|null
     */
     ...
     * Sets cloud_archive
     *
     * @param \OpenAPI\Client\Model\CreateImageTargetCollectionBodyCloudArchive|null $cloud_archive cloud_archive
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Optional - Arbitrary JSON data that should be stored together with the Target Collection.
     *
     * @return self
     */
