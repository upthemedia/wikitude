...
/**
 * RenameObjectTargetBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RenameObjectTargetBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenameObjectTargetBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['real_world_scale']) && ($this->container['real_world_scale'] <= 0)) {
            $invalidProperties[] = "invalid value for 'real_world_scale', must be bigger than 0.";
        }
     ...
     *
     * @param float|null $real_world_scale Optional - The physical (real world) size of the Target, in millimeters. Set to null to reset.
     *
     * @return self
     */
    public function setRealWorldScale($real_world_scale)
    {
        ...
        if (!is_null($real_world_scale) && ($real_world_scale <= 0)) {
            throw new \InvalidArgumentException('invalid value for $real_world_scale when calling RenameObjectTargetBody., must be bigger than 0.');
        }
