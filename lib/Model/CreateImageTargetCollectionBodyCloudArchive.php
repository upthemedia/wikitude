...
/**
 * CreateImageTargetCollectionBodyCloudArchive Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateImageTargetCollectionBodyCloudArchive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateImageTargetCollectionBody_cloudArchive';
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Optional - Activates an Image Target Collection for cloud recognition. All containing Image Targets are added to the quota. If the value is \"false\", the cloud archive can not be generated and an error is returned by the cloud archive generation endpoint. Default: true
     *
     * @return self
     */
