...
/**
 * SimilarityCheckBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SimilarityCheckBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimilarityCheckBody';
    ...
    protected static $openAPITypes = [
        'images' => '\OpenAPI\Client\Model\SimilarityCheckBodyImages[]'
    ];
     ...
     * Gets images
     *
     * @return \OpenAPI\Client\Model\SimilarityCheckBodyImages[]|null
     */
     ...
     * Sets images
     *
     * @param \OpenAPI\Client\Model\SimilarityCheckBodyImages[]|null $images Up to 10 images hosted via https. Supported file formats are JPEG and non transparent PNG. An item in the array must be a JSON Object and contain an \"imageUrl\" attribute.
     *
     * @return self
     */
