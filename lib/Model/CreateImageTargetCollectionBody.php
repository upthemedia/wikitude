...
/**
 * CreateImageTargetCollectionBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateImageTargetCollectionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateImageTargetCollectionBody';
     ...
     * Sets name
     *
     * @param string|null $name Required - Name of the Target Collection.
     *
     * @return self
     */
