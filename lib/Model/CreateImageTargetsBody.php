...
/**
 * CreateImageTargetsBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateImageTargetsBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateImageTargetsBody';
     ...
     * Sets name
     *
     * @param string|null $name Required - Name of the Target.
     *
     * @return self
     */
     ...
     *
     * @param float|null $physical_height Optional - The physical (real world) height of the target, in millimeters.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Optional - Arbitrary JSON data that should be stored together with the Target.
     *
     * @return self
     */
