...
/**
 * ImageTargetCollectionResponseCloudArchive Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImageTargetCollectionResponseCloudArchive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageTargetCollectionResponse_cloudArchive';
    ...
    protected static $attributeMap = [
        'enabled' => 'enabled',
        'version' => 'version',
        'validity_key_date' => 'validityKeyDate'
    ];
    ...
    protected static $setters = [
        'enabled' => 'setEnabled',
        'version' => 'setVersion',
        'validity_key_date' => 'setValidityKeyDate'
    ];
    ...
    protected static $getters = [
        'enabled' => 'getEnabled',
        'version' => 'getVersion',
        'validity_key_date' => 'getValidityKeyDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['validity_key_date'] = $data['validity_key_date'] ?? null;
    }
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Activates an Image Target Collection for cloud recognition. All containing Image Targets are added to the quota. If the value is \"false\", the cloud archive can not be generated and an error is returned by the cloud archive generation endpoint. Default: true
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Version of the latest cloud archive.
     *
     * @return self
     */
    ...
    /**
     * Gets validity_key_date
     *
     * @return string|null
     */
    public function getValidityKeyDate()
    {
        return $this->container['validity_key_date'];
    }

    /**
     * Sets validity_key_date
     *
     * @param string|null $validity_key_date Timestamp of the latest cloud archive generation.
     *
     * @return self
     */
    public function setValidityKeyDate($validity_key_date)
    {
        $this->container['validity_key_date'] = $validity_key_date;
