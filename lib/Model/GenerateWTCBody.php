...
/**
 * GenerateWTCBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GenerateWTCBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateWTCBody';
     ...
     * Sets sdk_version
     *
     * @param string|null $sdk_version Optional - Version of the Wikitude SDK the generated WTC file will be used for. Valid values \"4.1\", \"5.0\", \"5.1\", \"5.2\", \"5.3\", \"6.0\", \"6.1\", \"6.2\", \"7.0\", \"7.1\", \"7.2\", \"8.0\", \"8.5\". Default: 6.2
     *
     * @return self
     */
