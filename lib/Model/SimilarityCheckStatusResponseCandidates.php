...
/**
 * SimilarityCheckStatusResponseCandidates Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SimilarityCheckStatusResponseCandidates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimilarityCheckStatusResponse_candidates';
    ...
    {
        $this->container['target_name'] = $data['target_name'] ?? null;
     ...
     * Sets target_name
     *
     * @param string|null $target_name Name of similar Image Target.
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param string|null $score Accuracy of similarity prediction.
     *
     * @return self
     */
