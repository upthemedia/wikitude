...
/**
 * ExtendObjectTargetBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExtendObjectTargetBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendObjectTargetBody';
     ...
     * Sets images
     *
     * @param string[]|null $images Required - List of Images the Object Target should be extended with.
     *
     * @return self
     */
     ...
     * Sets fov
     *
     * @param float|null $fov Optional - Field of view.
     *
     * @return self
     */
    public function setFov($fov)
    {
        ...
        if (!is_null($fov) && ($fov > 180)) {
            throw new \InvalidArgumentException('invalid value for $fov when calling ExtendObjectTargetBody., must be smaller than or equal to 180.');
        }
        if (!is_null($fov) && ($fov < 40)) {
            throw new \InvalidArgumentException('invalid value for $fov when calling ExtendObjectTargetBody., must be bigger than or equal to 40.');
        }
