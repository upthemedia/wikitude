...
/**
 * GenerateWTOBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GenerateWTOBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateWTOBody';
     ...
     * Sets sdk_version
     *
     * @param string|null $sdk_version Optional - Version of the Wikitude SDK the WTO resource will be generated for. Must be set to \"8.0\" since versions \"7.0\", \"7.1\", \"7.2\" are not supported anymore. Default: 8.0
     *
     * @return self
     */
     ...
     * Sets e_mail
     *
     * @param string|null $e_mail Optional - The e-mail address, the notification is sent after the generation of the resource is finished. If non is specified, retrieve the generated resource from the corresponding generation status endpoint.
     *
     * @return self
     */
