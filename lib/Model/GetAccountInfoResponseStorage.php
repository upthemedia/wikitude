...
/**
 * GetAccountInfoResponseStorage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAccountInfoResponseStorage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAccountInfoResponse_storage';
     ...
     * Sets used
     *
     * @param float|null $used The amount of storage being used in bytes.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param float|null $limit The storage limit of the account in bytes.
     *
     * @return self
     */
