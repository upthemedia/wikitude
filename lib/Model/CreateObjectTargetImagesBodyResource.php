...
/**
 * CreateObjectTargetImagesBodyResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateObjectTargetImagesBodyResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateObjectTargetImagesBody_resource';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fov'] = $data['fov'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fov']) && ($this->container['fov'] > 180)) {
            $invalidProperties[] = "invalid value for 'fov', must be smaller than or equal to 180.";
        }

        if (!is_null($this->container['fov']) && ($this->container['fov'] < 40)) {
            $invalidProperties[] = "invalid value for 'fov', must be bigger than or equal to 40.";
        }
     ...
     * Sets uri
     *
     * @param string[]|null $uri Required - List of images resource URLs the Object Target should be generated with.
     *
     * @return self
     */
    ...
    {
        return $this->container['fov'];
    }

    /**
     * Sets fov
     *
     * @param float|null $fov Required - Field of view.
     *
     * @return self
     */
    public function setFov($fov)
    {
        ...
        if (!is_null($fov) && ($fov > 180)) {
            throw new \InvalidArgumentException('invalid value for $fov when calling CreateObjectTargetImagesBodyResource., must be smaller than or equal to 180.');
        }
        if (!is_null($fov) && ($fov < 40)) {
            throw new \InvalidArgumentException('invalid value for $fov when calling CreateObjectTargetImagesBodyResource., must be bigger than or equal to 40.');
        }

        $this->container['fov'] = $fov;
