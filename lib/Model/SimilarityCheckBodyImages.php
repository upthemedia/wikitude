...
/**
 * SimilarityCheckBodyImages Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SimilarityCheckBodyImages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimilarityCheckBody_images';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['max_candidates'] = $data['max_candidates'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_candidates']) && ($this->container['max_candidates'] > 10)) {
            $invalidProperties[] = "invalid value for 'max_candidates', must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['max_candidates']) && ($this->container['max_candidates'] < 1)) {
            $invalidProperties[] = "invalid value for 'max_candidates', must be bigger than or equal to 1.";
        }
     ...
     * Sets image_url
     *
     * @param string|null $image_url Required - URL to the Target Image resource.
     *
     * @return self
     */
     ...
     * Sets max_candidates
     *
     * @param float|null $max_candidates Optional - Specifies the maximum number of similar Targets.
     *
     * @return self
     */
    public function setMaxCandidates($max_candidates)
    {
        ...
        if (!is_null($max_candidates) && ($max_candidates > 10)) {
            throw new \InvalidArgumentException('invalid value for $max_candidates when calling SimilarityCheckBodyImages., must be smaller than or equal to 10.');
        }
        if (!is_null($max_candidates) && ($max_candidates < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_candidates when calling SimilarityCheckBodyImages., must be bigger than or equal to 1.');
        }
