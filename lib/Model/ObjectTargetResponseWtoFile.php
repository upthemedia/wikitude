...
/**
 * ObjectTargetResponseWtoFile Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObjectTargetResponseWtoFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectTargetResponse_wtoFile';
    ...
    protected static $attributeMap = [
        'transformed_json_uri' => 'transformedJSONUri',
        'uri' => 'uri',
    ...
    protected static $setters = [
        'transformed_json_uri' => 'setTransformedJsonUri',
        'uri' => 'setUri',
        'point_count' => 'setPointCount'
    ];
    ...
    protected static $getters = [
        'transformed_json_uri' => 'getTransformedJsonUri',
        'uri' => 'getUri',
    ...
    {
        $this->container['transformed_json_uri'] = $data['transformed_json_uri'] ?? null;
        $this->container['uri'] = $data['uri'] ?? null;
        $this->container['point_count'] = $data['point_count'] ?? null;
    }
    ...
    /**
     * Gets transformed_json_uri
     *
     * @return string|null
     */
    public function getTransformedJsonUri()
    {
        return $this->container['transformed_json_uri'];
    }

    /**
     * Sets transformed_json_uri
     *
     * @param string|null $transformed_json_uri URL to the transformation json resource.
     *
     * @return self
     */
    public function setTransformedJsonUri($transformed_json_uri)
    {
        $this->container['transformed_json_uri'] = $transformed_json_uri;
     ...
     * Sets uri
     *
     * @param string|null $uri URL to the WTO resource.
     *
     * @return self
     */
    ...
    {
        return $this->container['point_count'];
    }

    /**
     * Sets point_count
     *
     * @param float|null $point_count Number of distinct points in the point cloud.
     *
     * @return self
     */
    public function setPointCount($point_count)
    {
        $this->container['point_count'] = $point_count;
