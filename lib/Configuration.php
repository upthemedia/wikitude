...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-eu.wikitude.com/cloudrecognition';
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api-eu.wikitude.com/cloudrecognition",
                "description" => "Wikitude Studio API - Region Europe (recommended)",
            ],
            [
                "url" => "https://api-us.wikitude.com/cloudrecognition",
                "description" => "Wikitude Studio API - Region US (deprecated)",
            ]
        ];
    }
