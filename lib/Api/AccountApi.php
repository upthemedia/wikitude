...
class AccountApi
{
     ...
     * @return \OpenAPI\Client\Model\GetAccountInfoResponse
     */
    public function getAccount($x_version, $x_token)
    {
        list($response) = $this->getAccountWithHttpInfo($x_version, $x_token);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetAccountInfoResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountWithHttpInfo($x_version, $x_token)
    {
        $request = $this->getAccountRequest($x_version, $x_token);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetAccountInfoResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetAccountInfoResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\GetAccountInfoResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetAccountInfoResponse',
     ...
     */
    public function getAccountAsync($x_version, $x_token)
    {
        return $this->getAccountAsyncWithHttpInfo($x_version, $x_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountAsyncWithHttpInfo($x_version, $x_token)
    {
        $returnType = '\OpenAPI\Client\Model\GetAccountInfoResponse';
        $request = $this->getAccountRequest($x_version, $x_token);
