...
class ProjectApi
{
     ...
     * @return AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[]
     */
    public function getProjects($x_version, $x_token, $skip = null, $limit = null)
    {
        list($response) = $this->getProjectsWithHttpInfo($x_version, $x_token, $skip, $limit);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getProjectsWithHttpInfo($x_version, $x_token, $skip = null, $limit = null)
    {
        $request = $this->getProjectsRequest($x_version, $x_token, $skip, $limit);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = 'AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[]';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[]',
     ...
     */
    public function getProjectsAsync($x_version, $x_token, $skip = null, $limit = null)
    {
        return $this->getProjectsAsyncWithHttpInfo($x_version, $x_token, $skip, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProjectsAsyncWithHttpInfo($x_version, $x_token, $skip = null, $limit = null)
    {
        $returnType = 'AnyOfImageTargetCollectionResponseObjectTargetCollectionResponse[]';
        $request = $this->getProjectsRequest($x_version, $x_token, $skip, $limit);
     ...
     */
    public function getProjectsRequest($x_version, $x_token, $skip = null, $limit = null)
    {
        // verify the required parameter 'x_version' is set
        if ($x_version === null || (is_array($x_version) && count($x_version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_version when calling getProjects'
            );
        }
        // verify the required parameter 'x_token' is set
        if ($x_token === null || (is_array($x_token) && count($x_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_token when calling getProjects'
            );
        }
